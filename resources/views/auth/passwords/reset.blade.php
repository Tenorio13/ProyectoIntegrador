        ...
        <div class="row">
          ...
          <div class=" text-center" >
                                    ...
                                    <span class="login100-form-title p-b-34 p-t-27">
                                      <h2 class="text-center title" style="font-size:15px;">Restablece tu cuenta:<br>{{ $name }}<br>{{ $apellidos }}</h2>
                ...
                <center>
                  ...
                  <h2 class="text-center title" style="font-size:15px;">Restablece tu cuenta con siguiente codigo:</h2>
                  <h2 class="text-center title" >{{ $code }}</h2>
